...
export default function TermsOfService() {
  return (
    <div style={{ padding: "20px", fontFamily: "Arial, sans-serif" }}>
      ...
      <strong>OVERVIEW</strong> <br /> This website is operated by mazed.
      Throughout the site, the terms “we”, “us” and “our” refer to mazed. mazed
      ...
      In no case shall mazed, our directors, officers, employees, affiliates,
      ...
      indemnify, defend and hold harmless mazed and our parent, subsidiaries,
