      ...
      <div className="container mx-auto">
        ...
        <div className="w-full text-center sm:p-8 dark:border-gray-700 dark:bg-gray-800">
          <Image
            ...
            width={128}
            height={128}
            className="mx-auto my-4 h-16 w-16 rounded-xl"
          ></Image>
          ...
          <div className="items-center justify-center space-y-4 sm:flex sm:space-x-4 sm:space-y-0 rtl:space-x-reverse">
            ...
            <p className="mt-4 text-center text-sm">
              ...
              <Link
                href="https://www.tiktok.com/@onlyforg_com?_t=8oIAFkWAoB8&_r=1"
                target="_blank"
          ...
          <br />
          <hr />
          <h5 className="mt-6 text-2xl font-bold text-gray-900 dark:text-white">
            Enter your code:
          </h5>
